...
export interface ApiInvestorInvestor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    form: Schema.Attribute.Component<'investors.investorsform', false>;
    ...
    investorsheading: Schema.Attribute.Component<
      ...
      true
    >;
    investorsHero: Schema.Attribute.Component<'hero-section.hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiLandingPageLandingPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    grow: Schema.Attribute.Component<
      'landing-page.grow-your-business-section',
      true
    >;
    herosection: Schema.Attribute.Component<'landing-page.herosection', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTravelagentTravelagent extends Struct.CollectionTypeSchema {
  collectionName: 'travelagents';
  info: {
    displayName: 'travelagent';
    pluralName: 'travelagents';
    singularName: 'travelagent';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    benefits: Schema.Attribute.Component<'benefits.benefits-section', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featureSeaction: Schema.Attribute.Component<
      'feature.feature-section',
      true
    >;
    heading: Schema.Attribute.Component<'mainheading.mainheading', false>;
    hero: Schema.Attribute.Component<'hero-section.herosection', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::travelagent.travelagent'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    solution: Schema.Attribute.Component<
      'travelagentsol.travelagentsolution',
      false
    >;
    travelagentlove: Schema.Attribute.Component<
      'travelagentlove.travelagentlove',
      false
    >;
    travelagentproblem: Schema.Attribute.Component<
      'prob.travelagent-prob',
      false
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visaApplication: Schema.Attribute.Component<
      'visaapplication.visa-application-section',
      false
    >;
    visaprocess: Schema.Attribute.Component<'visa-process.visaprocess', false>;
  };
}
